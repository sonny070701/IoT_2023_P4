...
#define TOKEN "BBFF-9s4ssNAd21GHdhjCLusJn3oSi8mipR" // Ubidots TOKEN name el mismo que usamos en clase
#define MQTT_CLIENT_NAME "SONNY" //ID del cliente, 8 a 12 chars alfanumericos (ASCII), debe ser random y unico dif a otros devices
#define VARIABLE_LABEL_temp "temperatura" // Variable Temperatura
#define VARIABLE_LABEL_hum "humedad" // Variable Humedad
#define DEVICE_LABEL "tu device name" // Nombre del dispositivo a crear
